        ...
        <Fragment>
            <main  >
                <section className=" bg-stone-900 border    border-cyan-500 text-center m-5 h-fit w-fit  p-4  rounded-3xl" >
                    <div  className="  shadow-inner border-b-4 shadow-slate-200 w-56 h-56  bg-center  bg-contain bg-no-repeat hover:scale-105   mx-4 rounded-lg  "  style={{backgroundImage:`url(${data.image})`}} >
